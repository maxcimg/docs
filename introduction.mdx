...
A list of configurable options that define project targets. These allow to adjust code to the specific of the user project.
  ...
  <Card
    ...
    href="/pages/generating-drivers"
  >
A deterministic code generation provides high quality and stability of the output code. This can gurarntee the following of the specified code standatrts required by the project.
  </Card>
</CardGroup>
...
[💡 Learn more about interacting with the digital component model](/pages/digital-component-model)

## [Project Options](/pages/project-options)
...
[💡 Learn more about project options](/pages/project-options)

## [Code Generator](/pages/generating-drivers)
...
[💡 Learn more about driver generator](/pages/generating-drivers)
