...
<img width="500" src="../images/digital-component-model/device_info.png" style="border-radius: 7px;">
...
<img width="600" src="../images/digital-component-model/registers.png" style="border-radius: 7px;">
...
<img src="../images/digital-component-model/registers2.png" style="border-radius: 7px;">
...
2. **Select Registers:**
    ...
    **Note:** Only registers with `W` (write) and `RW` (read/write) access types will be displayed. If some registers are missing, return to the Registers section to update their access types.
