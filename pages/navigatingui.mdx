...
<video autoPlay muted loop playsInline className="w-full aspect-video" src="https://embedd.it/img/explorer2.gif" />
...
### <u>Here's the typical workflow:</u>
