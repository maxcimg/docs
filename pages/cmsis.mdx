...
<Accordion title="ReadMe" defaultOpen={false}>
  ````
  # Description
...
| embedd\_event.c               |             |
| embedd\_event.h               |             |
| embedd\_event\_types.h        |             |
| embedd\_event\_manager\_cgf.h |             |
| embedd\_event\_manager.c      |             |
| embedd\_error.h               |             |
| embedd\_i2c.c                 |             |
| embedd\_i2c.h                 |             |
| embedd\_spi.c                 |             |
| embedd\_spi.h                 |             |
| embedd\_BUS\_cmsis.c          |             |
| embedd\_BUS\_cmsis.h          |             |
| README.md                     |             |