...
**The Component Explorer is organised as follows:**
  ...
  <video autoPlay muted loop playsInline className="w-full aspect-video" src="https://static.embedd.it/img/explorer2.mp4" />
...
**The Application Screen** uses a tab-based interface similar to VSCode.&#x20;
  ...
  <video autoPlay muted loop playsInline className="w-full aspect-video" src="https://static.embedd.it/img/ApplicationScreen.mp4" />
